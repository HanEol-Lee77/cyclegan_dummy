...
def get_transform3D(opt, params=None, dim='3D', method=Image.BICUBIC, convert=True): # dim='3D' or '4D'
...
def get_transform(opt, params=None, grayscale=False, method=Image.BICUBIC, convert=True):
    ...
    if convert:
        ...
        if grayscale:
            ...
            transform_list += [transforms.Normalize((0.5,)*60, (0.5,)*60)] # [transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))]
